                ...
                <div className="mx-auto max-w-xl lg:max-w-3xl lg:px-12">
                    ...
                    <div className="mt-12 flex flex-row gap-10 justify-center">
                        ...
                        {isDownloading ? (
                            ...
                            <button
                                className='w-40 inline-flex justify-center rounded-2xl bg-indigo-600 p-4 text-base font-semibold text-white hover:bg-indigo-500 focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 active:text-white/70'
