export default function DiscoverSkeleton() {
    const audioData = Array.from({ length: 12 }, (_, i) => i + 1)
    return (
        <div className="sm:pt-24 pt-12 bg-gradient-to-r from-[#ECF5FF] via-[#d2deee] to-[#ECF5FF]">
            <h1 className='text-center text-3xl font-bold p-4'>
                You do not have any music yet, try generating some!
            </h1>
            <p className="text-center text-xl font-bold mt-4 text-slate-500 underline">
